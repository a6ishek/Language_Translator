...
public class MainActivity2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
                ...
                new ActivityResultCallback<ActivityResult>() {
                            ...
                            ActivityResult result)
                    {
                        ...
                        if (data != null) {
                            ...
                            byte[] byteData = getBytes(MainActivity2.this, sUri);

                            edtLanguage.setText(new String(byteData));
                            /* Communication without edit text via intent
                            String val = new String(byteData);
                            Intent j = new Intent(MainActivity2.this,MainActivity2.class);
                            j.putExtra("byte", val);
                            startActivity(j);*/
        ...
        clearBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                fileUri.setText("");
                filePath.setText("");
                Toast.makeText(MainActivity2.this,"Cleared",Toast.LENGTH_LONG).show();
            }
        });
    }
    ...
    private void translateLanguage(String input) {
        englishGermanTranslator.translate(input).addOnSuccessListener(new OnSuccessListener<String>() {
            ...
            @Override
            public void onFailure(@NonNull Exception e) {
                Toast.makeText(MainActivity2.this, "Fail to translate", Toast.LENGTH_SHORT).show();
            }
        });
